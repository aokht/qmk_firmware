...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        // right hand
        KC_RGHT,     KC_7,   KC_8,     KC_9,    KC_0,    KC_MINS, KC_EQL,
        KC_NO,       KC_Y,   KC_U,     KC_I,    KC_O,    KC_P,    KC_BSLS,
                     KC_H,   KC_J,     KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_RALT,     KC_N,   KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                             MO(MDIA), MO(SYMB),KC_LBRC, KC_RBRC, KC_FN1,
...
[MDIA] = KEYMAP(
    ...
    // right hand
       KC_TRNS,  KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_TRNS, KC_HOME,       KC_PGUP, KC_END,        KC_TRNS, KC_TRNS,
                 KC_LEFT, KC_DOWN,       KC_UP,   KC_RGHT,       KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_TRNS, LCTL(KC_LEFT), KC_PGDN, LCTL(KC_RGHT), KC_TRNS, KC_TRNS,
                          KC_TRNS,       KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [2] = ACTION_LAYER_TAP_TOGGLE(MDIA)                // FN2 - Momentary Layer 2 (Media & Mouse)
};
